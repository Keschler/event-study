...
from src.core.io_raw import write_raw_dump
from src.market.market_data import compute_daily_returns, download_daily_prices
...
def run_scrape(config: dict) -> Path:
    ...
    posts = scrape_user_posts(
        ...
        min_request_interval_s=float(scrape_cfg.get("min_request_interval_s", 2.5)),
        max_wait_s=float(scrape_cfg.get("max_wait_s", 3600.0)),
